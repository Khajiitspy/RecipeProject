...
namespace Domain.Migrations
{
    ...
    [Migration("20260118164059_Add_IsApprove_IngredientEntity")]
    partial class Add_IsApprove_IngredientEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.RecipeEntity", b =>
                {
                    b.HasOne("Domain.Data.Entities.CategoryEntity", "Category")
                        .WithMany("Recipes")
            ...
            modelBuilder.Entity("Domain.Entities.RecipeIngredientEntity", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.IngredientUnitEntity", "Unit")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<long>", b =>
                {
                    b.HasOne("Domain.Data.Entities.Identity.RoleEntity", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
